...
class Unet(object):
        ...
        with tf.Graph().as_default() as graph:
            ...
            for layer in range(self.layers):
                ...
                with tf.variable_scope("down_{}".format(layer)):
                    ...
                    self.logger.info(
                        "[down_{}] last layer shape : {}".format(layer, layer2.shape))
            # bottom of U-Net
            with tf.variable_scope('middle'):
                ...
                self.in_node = layer2
                self.logger.info(
                    "[middle] last layer shape : {}".format(layer2.shape))
            ...
            for layer in range(self.layers - 1, -1, -1):
                ...
                with tf.variable_scope("up_{}".format(layer)):
                    ...
                    self.in_node = layer2
                    self.logger.info(
                        "[up_{}] last layer shape : {}".format(layer, layer2.shape))
            # OUTPUT
            ...
            self.logger.info(
                "[output] output shape : {}".format(self.logits.shape))
    ...
    def _get_acc(self):
        with tf.variable_scope("indicator"):
            ...
            self.iou = tf.metrics.mean_iou(
                flat_pred, flat_label, num_classes=3, name="iou")
